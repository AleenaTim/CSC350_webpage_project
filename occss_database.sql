...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2021 at 02:15 AM
...
INSERT INTO `users` (`ID`, `firstName`, `lastName`, `email`, `password`, `Two_Factor`) VALUES
(24, 'John', 'Doe', 'JohnDoe@cuny.edu', 'abc123abc', '0'),
(26, 'Aleena', 'Tim', 'aleenatim@gmail.com', 'a', '0');
